...
public abstract class Controller {
  ...
  void scoreHandler(String password, Pane redPane, Pane orangePane, Pane greenPane, Pane bluePane) {
    ...
    for (int i = 0; i < 4; i++) {
      if (array[i] == 1) arrayPanes[i].setStyle("-fx-background-color: " + arrayColers[i + 1]);
      else {
