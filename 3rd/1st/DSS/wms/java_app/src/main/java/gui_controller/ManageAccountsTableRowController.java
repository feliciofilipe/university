  ...
  public void setData(List<String> info) {
    ...
    switch (info.get(5).toUpperCase()) {
      case "ADMIN":
        ...
        image2.setImage(new Image(getClass().getResourceAsStream("../images/profile/admin.png")));
        break;
      ...
      case "FLOORWORKER":
        ...
        image2.setImage(
            new Image(getClass().getResourceAsStream("../images/profile/floorworker.png")));
        break;
      ...
      case "TRUCKDRIVER":
        ...
        image2.setImage(
            new Image(getClass().getResourceAsStream("../images/profile/truckdriver.png")));
        break;
