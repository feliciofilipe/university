...
public class DashboardController extends UserController implements Initializable {
    ...
    public void populate() {
        ...
        /*
        changeLastProductsTable(wms.getLastPallet, wms.getInOrOut); //TODO : GET LAST RECEIVED OR SHIPPED PRODUCT
                                                                    //TODO : GET STRING "IN" OR "OUT"

        changeBarChart(wms.getWeeklyShipments()); // TODO : GET LIST OF VALUES OF THE WAREHOUSE WEEKLY SHIPMENTS
                                                  // Ex :Arrays.asList(30,20,12,42,53,67,89)
        */
    ...
    @FXML
    private void changeLastProductsTable(List<String> pallet, String type) {
        ...
        try {
            ...
            DashboardTableRowController ptvc = fxmlLoader.getController();
            ptvc.setData(pallet, type);

            if (productsTable.getChildren().size() >= 6) {
                productsTable.getChildren().remove(1);
            }
